        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusOfDelivery = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedDeliveryTime = table.Column<int>(type: "int", nullable: false, defaultValue: 45),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RouteTimeMinutes = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    View = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Pending"),
                    BrandName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BrandStreet = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    BrandCity = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BrandCountry = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
